...
- Name: mobile.spec.ts >> SIGO-Ollas Mobile E2E Tests (15 escenarios) >> Test 08: Inventario muestra lista de stock actual
- Location: e2e\mobile.spec.ts:319:7
...
- main:
  ...
  - paragraph: Ingresa tu correo y contraseña para continuar
  - text: Correo electrónico o DNI
  - textbox "Correo electrónico o DNI":
    - /placeholder: ej. lideresa@olla.pe
    - text: admin@ollascomunes.pe
  - text: Contraseña
  - textbox "Contraseña":
    - /placeholder: ••••••••
    - text: admin123
