...
- Name: workspace.spec.ts >> SIGO-Ollas Workspace Admin E2E Tests (15 escenarios) >> Test 24.1: Mi Perfil - Edición de Datos (Mock) (Éxito)
- Location: e2e\workspace.spec.ts:408:7
...
Call log:
  - waiting for locator('#profile-email')
    ...
    - fill("admin-modificado@ollascomunes.pe")
  - attempting fill action
    ...
    - retrying fill action
      - waiting 100ms
    109 × waiting for element to be visible, enabled and editable
        - element is not enabled
      - retrying fill action
        - waiting 500ms
