...
- Name: mobile.spec.ts >> SIGO-Ollas Mobile E2E Tests (15 escenarios) >> Test 03: Login exitoso con TOTP dinámico
- Location: e2e\mobile.spec.ts:85:7
...
> 27  |   await expect(page.locator('#otp-code')).toBeVisible({ timeout: 45000 })
  ...
  100 |     await expect(page.locator('text=¡Hola,')).toBeVisible({ timeout: 35000 })
  101 |   })
  102 | 
  ...
  127 |     await expect(page.locator('text=¡Hola,')).toBeVisible({ timeout: 35000 })
```