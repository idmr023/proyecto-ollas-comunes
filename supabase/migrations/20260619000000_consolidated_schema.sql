-- ================================================================
-- PROYECTO: SIGO-Ollas
-- ESQUEMA: CONSOLIDADO FINAL
-- FECHA:    2026-06-19
-- DESCRIPCION: SaaS para gestion de ollas comunes.
--              Schema totalmente actualizado: consolida las 5
--              migraciones previas + modelo Prisma vigente.
-- ================================================================
...
CREATE TABLE tenants (
    ...
    category varchar(100) NOT NULL DEFAULT 'Municipalidad',
    location varchar(100) NOT NULL DEFAULT 'Lima',
...
-- ================================================================
-- 6. RECOMENDACIONES, ALERTAS Y DOCUMENTOS
-- ================================================================
...
-- ================================================================
-- 8. SINCRONIZACION OFFLINE
-- ================================================================

CREATE TABLE failed_sync_backups (
    id bigserial PRIMARY KEY,
...
CREATE INDEX idx_tenants_lat_lng ON tenants(latitude, longitude);
...
CREATE INDEX idx_failed_sync_backups_tenant_id ON failed_sync_backups(tenant_id);
CREATE INDEX idx_failed_sync_backups_user_id ON failed_sync_backups(user_id);
CREATE INDEX idx_failed_sync_backups_reported_at ON failed_sync_backups(reported_at);
...
INSERT INTO tenants (code, name, category, location, status) VALUES
('MUNI-LIMA-CENTRO', 'Municipalidad de Lima Centro', 'Municipalidad', 'Lima', 'active'),
('MUNI-SJL', 'Municipalidad de San Juan de Lurigancho', 'Municipalidad', 'Lima Este', 'active'),
('OLLAS-SOL-NORTE', 'Programa Ollas Solidarias Norte', 'Programa social', 'Lima Norte', 'active')
